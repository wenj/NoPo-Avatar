...
class DPTOutputAdapter_fix(DPTOutputAdapter):
    ...
    def forward(self, encoder_tokens: List[torch.Tensor], image_size=None, ray_embedding=None):
        ...
        path_1 = F.interpolate(path_1, size=(H // 2, W // 2), mode='bilinear', align_corners=True)
...
def create_dpt_head_debug(net, has_conf=False, out_nchan=3, postprocess_func=postprocess):
    """

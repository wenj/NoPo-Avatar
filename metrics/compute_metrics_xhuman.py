...
tmp_ours = './tmp/eval_xhuman/pred'
tmp_gt = './tmp/eval_xhuman/gt'
tmperr = './tmp/eval_xhuman/error'
...
# path to GT rgb
target = 'datasets/XHuman/val-multilhm'
# path to GT mask
mask = 'datasets/XHuman/val-multilhm'
# path to prediction
ours = 'outputs/test/train_thuman2.0_3views_res1024_xhuman'
